...
const Login = () => {
  ...
  return (
    ...
    >
      <Paper elevation={4} sx={{ display: "flex", width: "90%", maxWidth: 900, borderRadius: 4, overflow: "hidden" , boxShadow:"#212121ff"}}>
        <Grid container>
          <Grid
            item
            xs={12}
  ...
  Forgot Password?
                  <Link href="#" onClick={() => setShowForgotPassword(true)} sx={{ cursor: "pointer", color: "#004080" }}>
                  Reset Here
                  </Link>
                </Box>
