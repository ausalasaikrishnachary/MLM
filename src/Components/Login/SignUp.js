...
const handleLoginClick = () => {
  ...
  setTimeout(() => {
    ...
    return (
        ...
        >
            <Paper elevation={4} sx={{ display: "flex", width: "90%", maxWidth: 1000, borderRadius: 2, height: { xs: "110vh", md: "570px" } }}>
                <Grid container>
                    <Grid
                        item xs={12} md={6}
                        sx={{
              ...
              padding: 2,
                    ...
                    <Grid item xs={12} md={6} sx={{ p: 4, mt:2 }}>
                        ...
                        <form onSubmit={handleSubmit} encType="multipart/form-data">
                                                            ...
                                                            ? {
                                                                endAdornment: (
                                                                    <InputAdornment position="end">
                                                                        <IconButton onClick={togglePasswordVisibility} edge="end" sx={{ color: "#ffa000" }} >
                                        ...
                                        {roles
                                            ...
                                            .map((role) => (
                                                <MenuItem key={role.role_id} value={role.role_id}>
                                                    {role.role_name === "Agent" ? "Team" : role.role_name}
                                                </MenuItem>
                                            ))}
                                    </TextField>
                                </Grid>
                            ...
                            />
                        <Box sx={{ mt: 1, textAlign: "center", minHeight: "24px" }}>
