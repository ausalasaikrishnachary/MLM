...
const InvoiceDocument = ({ 
  ...
  const totalAmount = property.total || 0;
  const totalInWords = numberToWords(property.total);
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.outerBorder}>
          ...
          <View style={styles.invoiceDetailsRow}>
            <View style={styles.invoiceDetailsLeft}>
              ...
              <View style={styles.rowItem}>
                ...
                <Text style={styles.value}>: Due on Invoice</Text>
              </View>
              <View style={styles.rowItem}>
          ...
          <View style={styles.tableHeaderRow}>
            ...
            <Text style={[styles.tableCell, styles.colRate]}>Remaining Amount</Text>
          ...
          <View style={styles.tableDataRow}>
            ...
            <Text style={[styles.tableCell, styles.colItem]}>{property.title}</Text>
            <Text style={[styles.tableCell, styles.colQty]}>{property.value}</Text>
            <Text style={[styles.tableCell, styles.colRate]}>{property.remainingAmount || '0'}</Text>
            <Text style={[styles.tableCell, styles.colRate]}>{property.bookingAmount || '0'}</Text>
            <Text style={[styles.tableCell, styles.colTotal, { borderRight: 'none' }]}>{property.total || '0'}</Text>
          </View>
          ...
          <View style={styles.summaryRow}>
            ...
            <View style={styles.summaryRight}>
              ...
              <View style={styles.summaryItem}>
                ...
                <Text style={styles.boldSummary}>{property.total || '0'}</Text>
              </View>
            </View>
          </View>
