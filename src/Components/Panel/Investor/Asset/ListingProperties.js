...
import InvestorHeader from "../../../Shared/Investor/InvestorNavbar";
     ...
     useEffect(() => {
         const fetchListingProperties = async () => {
             try {
                 ...
                 if (data.listing && data.listing.properties) {
                     setProperties(data.listing.properties.list);
                     setFilteredProperties(data.listing.properties.list);
                 } else {
                     setProperties([]);
                 }
             } catch (error) {
 ...
 export default I_ListingProperties;
