...
const ClientAddPropertyForm = () => {
  ...
  // Error States - Matching the first file
  const [errors, setErrors] = useState({
    // Step 0 errors
    propertyTitle: false,
    category: false,
  ...
  const handleChange = (e) => {
    ...
    setFormData((prev) => {
      ...
      const commission = parseFloat(updated.company_commission) || 0;
  ...
  // Validation Functions - Matching the first file
  const validateStep0 = () => {
    const newErrors = {};
  ...
  const validateStep2 = () => {
    ...
    if (showBuiltupArea && (!formData.builtupArea || formData.builtupArea <= 0)) newErrors.builtupArea = true;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const formFields = {
        ...
        company_commission: formData.company_commission || '0.00',
        distribution_commission: formData.distribution_commission || '0.00',
        agent_commission_paid: formData.agent_commission_paid || '0.00',
        agent_commission_balance: formData.agent_commission_balance || '0.00',
