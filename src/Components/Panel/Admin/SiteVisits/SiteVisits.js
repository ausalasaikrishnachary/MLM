...
const SiteVisits = () => {
  ...
  // ✅ Edit handler
  const handleEdit = (id) => {
    navigate(`/a-admiteditsite/${id}`);
  };

  // ✅ Delete handler (fully working)
  const handleDelete = async (id) => {
    ...
    try {
      ...
      // ✅ Apply search filter again to reflect new data
          ...
          <Table sx={{ border: "1px solid black", width: "100%" }}>
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={cellStyle}>Site Owner Name</TableCell>
            ...
            <TableBody>
              {loading ? (
                <TableRow>
                  <TableCell colSpan={14} sx={noDataStyle}>
                ...
                paginatedData.map((visit, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell sx={cellBodyStyle}>
                      {visit.site_owner_mobile_number}
                    </TableCell>
                    <TableCell sx={cellBodyStyle}>
