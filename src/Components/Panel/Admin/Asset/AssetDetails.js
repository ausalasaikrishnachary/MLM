...
const AssetDetails = () => {
  ...
  const gradients = [
    ...
    "linear-gradient(135deg, #cc7a07ff, #f5e676ff)",   // beige → peach
  "linear-gradient(135deg, #b786e5ff, #f5e676ff)",   // lavender → light blue
  "linear-gradient(135deg, #f77062, #f5e676ff)",   // coral → magenta
