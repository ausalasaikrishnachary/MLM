...
// >
//   <image 
//     href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6Jx0jkiWZmFB76XOpkAuYDxTP-iy1W4Wjdw&s" 
//     x="0" 
//     y="0" 
//     width="100" 
//     height="100"
//   />
// </svg>
//                 <h3 style={{fontSize: '1.5rem', fontWeight: 'bold', color: '#60a5fa', margin: 0}}>SHRIRAJ</h3>
//               </div>
...
//                 {['Buy Property',   'Commercial', 'Plots/Land'].map((link) => (
//                   <button 
//                     key={link} 
//                     style={{
//                       color: '#d1d5db', 
...
//               <div style={{display: 'flex', flexDirection: 'column', gap: '0.5rem'}}>
//                 {['Property Valuation',    'Investment Advisory'].map((service) => (
//                   <button 
//                     key={service} 
//                     style={{
//                       color: '#d1d5db', 
...
//             <p style={{color: '#9ca3af'}}>© 2025 SHRIRAJ. All rights reserved.</p>
...
const LandingPage = () => {
  ...
  const styles = {
    ...
    heroText: {
      color: '#ffffff',
      boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.77)'
    },
    heroTitle: {
      fontSize: '3.5rem',
      fontWeight: 'bold',
...
>
  ...
  />
            ...
            <div>
              <h4 style={{fontSize: '1.125rem', fontWeight: '600', marginBottom: '1rem'}}>Quick Links</h4>
              <div style={{display: 'flex', flexDirection: 'column', gap: '0.5rem'}}>
                {['Buy Property',  'Plots/Land'].map((link) => (
                  <button 
                    key={link} 
                    style={{
                      color: '#d1d5db', 
