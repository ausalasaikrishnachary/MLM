        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={6}><Typography><strong>Floors:</strong> {property.number_of_floors}</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Facing:</strong> {property.facing}</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Open Sides:</strong> {property.number_of_open_sides}</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Roads:</strong> {property.number_of_roads}</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Road Width 1:</strong> {property.road_width_1_ft} ft</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Road Width 2:</strong> {property.road_width_2_ft} ft</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Ownership:</strong> {property.ownership_type}</Typography></Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Grid container spacing={2} mb={3}>
              <Grid item xs={6}><Typography><strong>Looking to:</strong> {property.looking_to}</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Property Value:</strong> {formatCurrency(property.total_property_value)}</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Category:</strong> {property.category}</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Property Type:</strong> {property.property_type}</Typography></Grid>
              <Grid item xs={12}><Typography><strong>Description:</strong> {property.description}</Typography></Grid>
            </Grid>
            ...
            <Divider sx={{ mb: 2 }} />
            <Grid container spacing={2} mb={3}>
              <Grid item xs={6}><Typography><strong>Plot Area:</strong> {property.plot_area_sqft} sq.ft</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Built-up Area:</strong> {property.builtup_area_sqft} sq.ft</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Length:</strong> {property.length_ft} ft</Typography></Grid>
              <Grid item xs={6}><Typography><strong>Breadth:</strong> {property.breadth_ft} ft</Typography></Grid>
            </Grid>
